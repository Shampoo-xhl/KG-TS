...
def get_deltaT_reward_distribution():
    theta_cat = pd.read_csv('KGTS_arm_reward_data/theta_cat.csv').values
    var_cat = pd.read_csv('KGTS_arm_reward_data/var_cat.csv').values
    theta_seller = pd.read_csv('KGTS_arm_reward_data/theta_seller.csv').values
    var_seller = pd.read_csv('KGTS_arm_reward_data/var_seller.csv').values
    theta_brand = pd.read_csv('KGTS_arm_reward_data/theta_brand.csv').values
    var_brand = pd.read_csv('KGTS_arm_reward_data/var_brand.csv').values

    deltaT_seller = pd.read_csv('KGTS_arm_reward_data/deltaT_seller.csv').values
    deltaT_brand = pd.read_csv('KGTS_arm_reward_data/deltaT_brand.csv').values
    deltaT_cat = pd.read_csv('KGTS_arm_reward_data/deltaT_cat.csv').values
...
def get_user_reward_weight():
    user_reward_weight = pd.read_csv('KGTS_arm_reward_data/user_reward_weight.csv').values
