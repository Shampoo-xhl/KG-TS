...
def init_train_reward(user_id, seller_list, brand_list, cat_list, theta_seller, var_seller, deltaT_seller,
    ...
    user_reward_weight.to_csv('./KGTS_arm_reward_data/user_reward_weight.csv', index=False)

    theta_seller.to_csv('./KGTS_arm_reward_data/theta_seller.csv', index=False)
    var_seller.to_csv('./KGTS_arm_reward_data/var_seller.csv', index=False)
    deltaT_seller.to_csv('./KGTS_arm_reward_data/deltaT_seller.csv', index=False)

    theta_brand.to_csv('./KGTS_arm_reward_data/theta_brand.csv', index=False)
    var_brand.to_csv('./KGTS_arm_reward_data/var_brand.csv', index=False)
    deltaT_brand.to_csv('./KGTS_arm_reward_data/deltaT_brand.csv', index=False)

    theta_cat.to_csv('./KGTS_arm_reward_data/theta_cat.csv', index=False)
    var_cat.to_csv('./KGTS_arm_reward_data/var_cat.csv', index=False)
    deltaT_cat.to_csv('./KGTS_arm_reward_data/deltaT_cat.csv', index=False)
